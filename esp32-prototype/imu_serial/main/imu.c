...
// Pins configured to our microcontroller. AD0 and INT are not used, we only are reading data from the device
// Do we need pullup resistors between SCL and SDA?
// See https://www.google.com/search?q=do+you+need+pullup+resistors+for+i2c+if+you+only+have+1+slave
// https://www.ti.com/lit/an/slva689/slva689.pdf?ts=1731140219749
