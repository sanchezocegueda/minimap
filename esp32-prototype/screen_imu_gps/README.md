# LUCA TLDR
This project is where current work on the screen is taking place. Alex is working on this currently.

We have some demos to display fake data on the screen and found a jank way to pass data to the screen.
- just using static structs for now, probably want to use rtos queues
# 
